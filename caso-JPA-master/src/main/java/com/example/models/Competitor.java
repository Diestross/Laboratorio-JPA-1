...
public class Competitor implements Serializable {
    ...
    public Competitor(String nameN, String surnameN, int ageN, String telephoneN, String cellphoneN, String addressN, String cityN, String countryN, boolean winnerN, String password, String email, List<Producto> product) {
        name = nameN;
        surname = surnameN;
        age = ageN;
